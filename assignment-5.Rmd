...
#Summary of model stats for female model: the model signficantly predicts female graduate enrollment. p < 0.001. R squared is 0.982. Correlation is 0.9913, indicating a strong positive correlation

#Summary of model stats for male model: the model signficantly predicts male graduate enrollment. p < 0.001. R squared is 0.8545. Correlation is 0.9568, indicating a strong positive correlation
